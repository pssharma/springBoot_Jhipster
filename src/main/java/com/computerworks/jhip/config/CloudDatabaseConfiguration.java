package com.computerworks.jhip.config;
...
@Configuration
@EnableMongoRepositories("com.computerworks.jhip.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.computerworks.jhip.config.dbmigrations");
