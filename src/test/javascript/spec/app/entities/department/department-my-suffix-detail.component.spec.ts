...
import { SpringbootJhipsterTestModule } from '../../../test.module';
    ...
    describe('DepartmentMySuffix Management Detail Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [SpringbootJhipsterTestModule],
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new DepartmentMySuffix('aaa')));
            ...
            expect(comp.department).toEqual(jasmine.objectContaining({id: 'aaa'}));
            });
        });
    });
